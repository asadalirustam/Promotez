...
import { Printer, Calendar, BarChart3, ArrowDownRight, ArrowUpRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-150 dark:border-gray-700 rounded-2xl shadow-sm p-6 sm:p-8 space-y-8 print:border-none print:shadow-none print:bg-white print:text-black">
          
          {/* Sheet Header */}
          <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-6 print:pb-4">
            <div>
              <h2 className="text-2xl font-black tracking-tight text-gray-900 dark:text-white print:text-black">
                CentWise Statement
              </h2>
            ...
            <button
              onClick={handlePrint}
              className="print:hidden flex items-center gap-2 px-4 py-2 border border-gray-200 dark:border-gray-700 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-all"
            >
              <Printer size={16} />
          ...
          {/* Statement Summaries */}
          <div className="grid grid-cols-3 gap-4 border border-gray-100 dark:border-gray-700/50 p-5 rounded-2xl bg-gray-50/50 dark:bg-gray-900/10 print:border-gray-200 print:bg-transparent">
            <div>
              <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Total Inflow</p>
              <p className="text-xl sm:text-2xl font-bold text-emerald-600 dark:text-emerald-400 mt-1">
                {formatCurrency(totalIncome)}
              </p>
            </div>
            <div>
              <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Total Outflow</p>
              <p className="text-xl sm:text-2xl font-bold text-rose-600 dark:text-rose-400 mt-1">
                {formatCurrency(totalExpense)}
              </p>
            </div>
            <div>
              <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Net Savings</p>
              <p className={`text-xl sm:text-2xl font-bold mt-1 ${netSavings >= 0 ? 'text-indigo-600 dark:text-indigo-400' : 'text-rose-500'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <h4 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider print:text-black">
                  ...
                  {categorySortedList.map((item) => (
                    <div key={item.category} className="space-y-1">
                      <div className="flex items-center justify-between text-sm font-semibold">
                        <span className="text-gray-700 dark:text-gray-300 print:text-black">{item.category}</span>
            ...
            <div className="space-y-4">
              ...
              <div className="divide-y divide-gray-100 dark:divide-gray-750">
                <div className="flex justify-between py-2 text-sm">
                  ...
                  <span className="font-semibold text-gray-900 dark:text-white print:text-black">{incomes.length} records</span>
                </div>
                <div className="flex justify-between py-2 text-sm">
                  <span className="text-gray-500">Expenses Count</span>
                  <span className="font-semibold text-gray-900 dark:text-white print:text-black">{expenses.length} records</span>
                </div>
                <div className="flex justify-between py-2 text-sm">
            ...
            {unifiedTransactions.length > 0 ? (
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm print:text-black">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-gray-700 text-gray-400 print:border-gray-300">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-750 print:divide-gray-200">
                    {unifiedTransactions.map((tx) => (
                      <tr key={tx._id} className="text-gray-700 dark:text-gray-300 print:text-black">
